...
public class ByteBuffer
{
    ...
    public static float IntToFloat(Int32 i)
    {
        ...
        byte[] st = new byte[4];
        st[0] = Convert.ToByte(str.Substring(6, 2), 16);
        st[1] = Convert.ToByte(str.Substring(4, 2), 16);
        st[2] = Convert.ToByte(str.Substring(2, 2), 16);
        st[3] = Convert.ToByte(str.Substring(0, 2), 16);
        float fl = BitConverter.ToSingle(st, 0);
        return fl;
    }
}
